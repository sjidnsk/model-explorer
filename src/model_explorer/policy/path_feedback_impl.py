...
_LEGACY_PRIVATE_EXPORTS = {
    ...
    "_aggregate_channel_aware_astar_diagnostics": "path_feedback_backend_diagnostics",
    "_aggregate_metric_stats": "path_feedback_diagnostic_aggregate",
    ...
    "_candidate_by_cell": "path_feedback_diagnostic_interpretation",
    ...
    "_channel_aware_astar_blocker_class": "path_feedback_backend_diagnostics",
    "_channel_aware_astar_diagnostics": "path_feedback_backend_diagnostics",
    "_channel_aware_astar_failure_taxonomy": "path_feedback_backend_diagnostics",
    "_channel_aware_astar_prefixed_fields": "path_feedback_backend_diagnostics",
    ...
    "_convex_region_candidate_audit": "path_feedback_candidate_audits",
    "_convex_region_diagnostics": "path_feedback_backend_diagnostics",
    "_counter_dict": "path_feedback_diagnostic_aggregate",
    "_dedupe": "feedback_selection",
    "_diagnostic_aggregate": "path_feedback_diagnostic_aggregate",
    "_diagnostic_interpretation_summary": "path_feedback_diagnostic_interpretation",
    "_empty_group_interpretation": "path_feedback_diagnostic_interpretation",
    "_empty_group_summary": "path_feedback_diagnostic_aggregate",
    "_fallback_status_is_problem": "feedback_selection",
    "_finite_float": "feedback_selection",
    "_finite_float_optional": "feedback_selection",
    "_first_float": "path_feedback_diagnostic_aggregate",
    "_first_present": "path_feedback_diagnostic_aggregate",
    "_float_value": "path_feedback_diagnostic_aggregate",
    "_gcs_candidate_audit": "path_feedback_candidate_audits",
    "_gcs_candidate_diagnostics": "path_feedback_backend_diagnostics",
    ...
    "_gcs_control_point_candidate_audit": "path_feedback_candidate_audits",
    "_gcs_control_point_candidate_triage_summary": "path_feedback_artifacts",
    "_gcs_control_point_diagnostics": "path_feedback_backend_diagnostics",
    "_gcs_control_point_triage_row": "path_feedback_artifacts",
    "_gcs_curvature_constrained_audit": "path_feedback_candidate_audits",
    "_gcs_curvature_constrained_diagnostics": "path_feedback_backend_diagnostics",
    "_gcs_motion_feasibility_audit": "path_feedback_candidate_audits",
    "_gcs_motion_feasibility_diagnostics": "path_feedback_backend_diagnostics",
    "_gcs_trajectory_candidate_audit": "path_feedback_candidate_audits",
    "_gcs_trajectory_diagnostics": "path_feedback_backend_diagnostics",
    "_goals_by_evaluation_action_index": "feedback_selection",
    "_int_value": "path_feedback_diagnostic_aggregate",
    "_iris_diagnostics": "path_feedback_backend_diagnostics",
    "_iris_region_graph_signal": "path_feedback_diagnostic_interpretation",
    ...
    "_numeric_metric_stats": "path_feedback_diagnostic_aggregate",
    "_numeric_observation": "path_feedback_runner",
    "_objective_term_weight": "path_feedback_artifacts",
    "_open_grid_fallback_used": "path_feedback_diagnostic_aggregate",
    "_optional_path": "path_feedback_manifest",
    "_optional_str": "path_feedback_diagnostic_aggregate",
    ...
    "_platform_goal_contract_mismatch": "path_feedback_backend_diagnostics",
    "_platform_goal_failure_class": "path_feedback_backend_diagnostics",
    ...
    "_primary_failure_reason": "path_feedback_diagnostic_interpretation",
    "_ranking_key": "feedback_selection",
    "_region_graph_diagnostics": "path_feedback_backend_diagnostics",
    "_region_graph_disconnected_count": "path_feedback_diagnostic_aggregate",
    ...
    "_sampled_region_path_candidate_audit": "path_feedback_candidate_audits",
    "_sampled_region_path_diagnostics": "path_feedback_backend_diagnostics",
    "_scenario_diagnostic_interpretation": "path_feedback_diagnostic_interpretation",
    "_scenario_failure_sources": "path_feedback_diagnostic_interpretation",
    ...
    "_string_tuple": "path_feedback_diagnostic_aggregate",
    "_target_replacement_reason": "path_feedback_diagnostic_interpretation",
    "_tracking_safety_violation_count": "path_feedback_diagnostic_aggregate",
    "_trajectory_optimization_fallback_count": "path_feedback_diagnostic_aggregate",
