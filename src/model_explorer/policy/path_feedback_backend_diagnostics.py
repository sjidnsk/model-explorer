...
def _sampled_region_path_diagnostics(evaluations) -> dict[str, Any]:
    ...
    return {'selected_count': selected_count, 'fallback_count': fallback_count, 'status_counts': dict(sorted(status_counts.items())), 'source_counts': dict(sorted(source_counts.items())), 'fallback_reasons': dict(sorted(fallback_reasons.items())), 'sample_attempt_count': sample_attempt_count, 'candidate_ranking_count': candidate_ranking_count, 'anchor_region_added_count': anchor_region_added_count, 'anchor_region_connected_count': anchor_region_connected_count, 'anchor_closure_attempt_count': anchor_closure_attempt_count, 'anchor_closure_connected_count': anchor_closure_connected_count, 'anchor_closure_status_counts': dict(sorted(anchor_closure_status_counts.items())), 'anchor_closure_reason_counts': dict(sorted(anchor_closure_reason_counts.items())), 'anchor_closure_connection_kind_counts': dict(sorted(anchor_closure_connection_kind_counts.items())), 'start_classification_counts': dict(sorted(start_classification_counts.items())), 'goal_classification_counts': dict(sorted(goal_classification_counts.items())), 'connector_attempt_count': connector_attempt_count, 'connector_strategy_counts': dict(sorted(connector_strategy_counts.items())), 'bridge_aware_connector_attempt_count': bridge_aware_connector_attempt_count, 'bridge_aware_connector_available_count': bridge_aware_connector_available_count, 'bridge_aware_connector_selected_count': bridge_aware_connector_selected_count, 'bridge_aware_connector_rejected_count': bridge_aware_connector_rejected_count, 'bridge_aware_connector_status_counts': dict(sorted(bridge_aware_connector_status_counts.items())), 'bridge_aware_fallback_reasons': dict(sorted(bridge_aware_fallback_reasons.items())), 'bridge_aware_bridge_cell_count': bridge_aware_bridge_cell_count, 'bridge_aware_mask_added_cell_count': bridge_aware_mask_added_cell_count, 'bridge_corridor_connector_attempt_count': bridge_corridor_connector_attempt_count, 'bridge_corridor_connector_available_count': bridge_corridor_connector_available_count, 'bridge_corridor_connector_selected_count': bridge_corridor_connector_selected_count, 'bridge_corridor_connector_rejected_count': bridge_corridor_connector_rejected_count, 'bridge_corridor_status_counts': dict(sorted(bridge_corridor_status_counts.items())), 'bridge_corridor_fallback_reasons': dict(sorted(bridge_corridor_fallback_reasons.items())), 'bridge_corridor_radius_counts': dict(sorted(bridge_corridor_radius_counts.items())), 'bridge_corridor_added_cell_count': bridge_corridor_added_cell_count, 'terminal_adjusted_count': terminal_adjusted_count, 'terminal_adjustment_candidate_count': terminal_adjustment_candidate_count, 'terminal_adjustment_status_counts': dict(sorted(terminal_adjustment_status_counts.items())), 'terminal_adjustment_reason_counts': dict(sorted(terminal_adjustment_reason_counts.items())), 'reachable_component_status_counts': dict(sorted(reachable_component_status_counts.items())), 'reachable_component_reason_counts': dict(sorted(reachable_component_reason_counts.items())), 'reachable_component_disconnected_count': reachable_component_disconnected_count, 'reachable_component_replacement_selected_count': reachable_component_replacement_selected_count, 'reachable_component_terminal_candidate_count': reachable_component_terminal_candidate_count, 'reachable_terminal_rescue_count': reachable_terminal_rescue_count, 'proxy_goal_anchor_selected_count': proxy_goal_anchor_selected_count, 'goal_rescue_candidate_count': goal_rescue_candidate_count, 'benefit_surface_present_count': benefit_surface_present_count, 'path_duplicate_with_baseline_count': path_duplicate_with_baseline_count, 'baseline_equivalent_count': baseline_equivalent_count, 'no_quality_gain_count': no_quality_gain_count, 'fixture_no_benefit_surface_count': fixture_no_benefit_surface_count, 'candidate_missing_metrics_count': candidate_missing_metrics_count, 'constrained_connector_failed_count': constrained_connector_failed_count, 'complexity_reason_counts': dict(sorted(complexity_reason_counts.items())), 'execution_tie_break_status_counts': dict(sorted(execution_tie_break_status_counts.items())), 'execution_tie_break_reason_counts': dict(sorted(execution_tie_break_reason_counts.items()))}
